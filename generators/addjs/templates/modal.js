    ...
    // @TODO - research better modal all together. Use plugin if possible. We need one that doesn't
    // apply fixed positioning - would prefer for it to be absolutely positioned so users can still
    // scroll on mobile.
